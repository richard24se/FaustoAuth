...
const ClaimsTable = ({ data }: { data: any }) => {
  ...
  return (
    <Table.Root variant="outline" size="sm">
      <Table.Header>
        <Table.Row>
          <Table.ColumnHeader borderColor={borderColor} color={textColor}>
            Claim
          </Table.ColumnHeader>
          <Table.ColumnHeader borderColor={borderColor} color={textColor}>
            Value
        ...
        <HStack gap={4}>
          ...
          {isSignatureValid === false && (
            <Badge colorPalette="orange" variant="solid" px={3} py={1} borderRadius="full">
              <Flex align="center" gap={2}>
                <FiAlertCircle /> SIGNATURE INVALID
              </Flex>
            </Badge>
          )}
        </HStack>
        ...
        <GridItem display="flex" flexDirection="column" gap={4} overflowY="auto">
          ...
          >
            <Flex justify="space-between" mb={2}>
              <Text fontWeight="bold" fontSize="xs" color={textColor} letterSpacing="wider">
                ENCODED TOKEN
              </Text>
              <HStack gap={2}>
            ...
            <Text fontSize="xs" color="gray.400" mt={2}>
              {inputToken === sessionToken
                ? 'Currently showing your active session token.'
                : 'Showing custom token.'}
            </Text>
          </Box>
          ...
          >
            ...
            <VStack align="stretch" gap={3}>
              <Flex align="center" gap={2}>
                <Badge
                  colorPalette={
                    isSignatureValid ? 'green' : isSignatureValid === false ? 'red' : 'gray'
                  }
                >
