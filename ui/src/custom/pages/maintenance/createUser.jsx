...
class createUser_ extends Component {
    ...
    getUsers = () => {
        ...
        const notiloading = this.props.notiloading("Getting users...")
    ...
    postUser = () => {
        if (this.state.user_names === "") {
            ...
            this.props.notiwarn("Fill in the surname field")
        } else if (this.state.user_role === "") {
            this.props.notiwarn("Select an role")
        } else if (this.state.user_username === "") {
            this.props.notiwarn("Fill in the username field")
        } else if (this.state.user_password === "") {
            this.props.notiwarn("Fill in the password field")
        } else if (this.state.user_password !== this.state.validate_user_password) {
            this.props.notiwarn("Passwords do not match")
        }
        else {
            const notiloading = this.props.notiloading("Saving the user...")
    ...
    deleteRole = id_user => {
        const notiloading = this.props.notiloading("Deleting user...")
