...
const structure = [
  ...
  // { id: 3, label: "Registrar notificación", link: "/app/registrar_notificacion", icon: <SpeakerNotesIcon /> },
  // { id: 2, label: "Generar programación", link: "/app/generar_programacion", icon: <AssessmentIcon /> },
  // { id: 3, label: "Generar planificación", link: "/app/generar_planificacion", icon: <AssignmentIcon /> },
