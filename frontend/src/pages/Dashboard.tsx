...
export default function Dashboard() {
  ...
  return (
    <Container maxW="7xl" py={8}>
      <Stack gap={8}>
        <Box>
          <Heading size="lg" mb={2}>{t('dashboard')}</Heading>
        ...
        <SimpleGrid columns={{ base: 1, lg: 3 }} gap={6}>
          <Card.Root>
            <Card.Body>
              <Stack gap={2}>
                <Text fontSize="sm" color="gray.500">{t('totalUsers')}</Text>
                ...
                <Text fontSize="xs" color="gray.400">80% active this month</Text>
              </Stack>
            </Card.Body>
          </Card.Root>
          ...
          <Card.Root>
            <Card.Body>
              <Stack gap={2}>
                <Text fontSize="sm" color="gray.500">{t('totalRoles')}</Text>
                ...
                <Text fontSize="xs" color="gray.400">{stats.roles} defined roles</Text>
              </Stack>
            </Card.Body>
          </Card.Root>
          ...
          <Card.Root>
             <Card.Body>
                <Stack gap={2}>
                  <Text fontSize="sm" color="gray.500">{t('totalTenants')}</Text>
                   ...
                   <Progress.Root value={60} size="sm" colorPalette="green">
                    ...
                    <Text fontSize="xs" color="gray.400">{stats.tenants} active tenants</Text>
                </Stack>
             </Card.Body>
          </Card.Root>
        </SimpleGrid>
             ...
             <Table.Root variant="outline">
               ...
               <Table.Body>
                 <Table.Row>
                   ...
                   <Table.Cell><Badge colorPalette="green">Success</Badge></Table.Cell>
                 </Table.Row>
                 <Table.Row>
                    <Table.Cell>user1</Table.Cell>
                    <Table.Cell>Update Profile</Table.Cell>
                    <Table.Cell>1 hour ago</Table.Cell>
                    <Table.Cell><Badge colorPalette="blue">Completed</Badge></Table.Cell>
                 </Table.Row>
               </Table.Body>
             </Table.Root>
           </Card.Body>
