...
SELECT pg_catalog.setval('auth.object_id_seq', 4, true);
...
SELECT pg_catalog.setval('auth.permission_type_id_seq', 3, true);
...
SELECT pg_catalog.setval('auth.rol_permission_id_seq', 2, true);
